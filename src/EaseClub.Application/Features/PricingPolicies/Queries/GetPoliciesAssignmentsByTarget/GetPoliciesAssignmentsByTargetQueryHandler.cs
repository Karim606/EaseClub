...
{
    public class GetPoliciesAssignmentsByTargetQueryHandler(IPricingPolicyRepository pricingPolicyRepository) : IRequestHandler<GetPoliciesAssignmentsByTargetQuery, Result<List<PolicyAssignmentResponse>>>
    {
